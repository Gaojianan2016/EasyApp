...
//            )
            ...
            //2020 元旦
            val day0 = createGregorianCalendar(2020).timeInMillis

            //2020 10 19 14 17 20
            val day1 = createGregorianCalendar(
                2020,
                month = 9,
                date = 19,
                hourOfDay = 14,
            ...
            //2020 10 19 10 00 00
            val day2 = createGregorianCalendar(
                2020,
                month = 9,
                date = 19,
                hourOfDay = 10
            ...
            //2020 10 18 14 00 00
            val day3 = createGregorianCalendar(
                2020,
                month = 9,
                date = 18,
                hourOfDay = 14
            ...
            //2020 10 11 00 00 00
            val day4 = createGregorianCalendar(2020, month = 9, date = 11).timeInMillis
            //2020 7 1 00 00 00
            val day5 = createGregorianCalendar(2020, month = 6, date = 1).timeInMillis

            val day55 = System.currentTimeMillis() - 3000
            val day555 = System.currentTimeMillis() - 10000

            //2019 12 22 00 00 00
            val day6 = createGregorianCalendar(2019, month = 11, date = 22).timeInMillis
            //2019 9 22 00 00 00
            val day7 = createGregorianCalendar(2019, month = 8, date = 22).timeInMillis

//            println("day1 ${elapsedTime(time = day1)}")
//            println("day2 ${elapsedTime(time = day2)}")
//            println("day3 ${elapsedTime(time = day3)}")
//            println("day4 ${elapsedTime(time = day4)}")
//            println("day5 ${elapsedTime(time = day5)}")
//            println("day55 ${elapsedTime(time = day55)}")
//            println("day555 ${elapsedTime(time = day555)}")
//            println("day6 ${elapsedTime(time = day6)}")
//            println("day7 ${elapsedTime(time = day7)}")
//            println("----------------------------------------")
//            println("day6 ${elapsedTime(day0, day6)}")
//            println("day7 ${elapsedTime(day0, day7)}")
        }
