...
object BaseLog {
    ...
    @JvmOverloads
    fun d(msg: String?, tag: String? = "baseLog", tr: Throwable? = null) {
        if (isDebug) LogUtil.d(tag, msg, tr)
    }

    @JvmOverloads
    fun v(msg: String?, tag: String? = "baseLog", tr: Throwable? = null) {
        if (isDebug) LogUtil.v(tag, msg, tr)
    }

    @JvmOverloads
    fun i(msg: String?, tag: String? = "baseLog", tr: Throwable? = null) {
        if (isDebug) LogUtil.i(tag, msg, tr)
    }

    @JvmOverloads
    fun w(msg: String?, tag: String? = "baseLog", tr: Throwable? = null) {
        if (isDebug) LogUtil.w(tag, msg, tr)
    }

    @JvmOverloads
    fun e(msg: String?, tag: String? = "baseLog", tr: Throwable? = null) {
        if (isDebug) LogUtil.e(tag, msg, tr)
    }

    @JvmOverloads
    fun wtf(msg: String?, tag: String? = "baseLog", tr: Throwable? = null) {
